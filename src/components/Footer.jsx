...
export default function Footer() {
  // Définition des routes correspondantes
  const navigationItems = [
    { label: 'Accueil', path: '/' },
    { label: 'OFFRE LEASING', path: '/leasing' },
    { label: 'DEVENEZ PARTENAIRE', path: '/partner' },
    { label: 'INVESTISSEZ AVEC NOUS', path: '/invest' },
  ...
  return (
    <div className="relative mt-32"> {/* Augmentation de l'espace pour le débordement */}
      ...
      <div className="absolute -top-32 left-0 right-0 h-64 z-20">
        ...
        <div className="bg-gradient-to-b from-[#1B1F2A] to-[#002B66] rounded-t-3xl shadow-xl h-full">
                  ...
                  >
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="bg-black text-[#ffffff] font-semibold px-6 py-3 rounded-full whitespace-nowrap shadow-md hover:shadow-lg transition-all"
                      >
                        S'inscrire
                      </motion.button>
                    </div>
      ...
      <footer className="bg-[#000] border-t border-gray-800 pt-32 pb-12 px-4 relative z-10">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-12 pt-16">
          ...
          >
            <div className="relative h-12 w-68 mb-6">
              <Image 
                src="/logo.png" 
                alt="S'Group" 
                width={110}
            ...
            <ul className="space-y-3">
              {navigationItems.map((item, i) => (
                ...
                >
                  <a
                    href={item.path}
                    className="text-gray-400 hover:text-[#ffffff] transition-colors flex items-center"
                  >
                    <svg className="w-4 h-4 mr-2 text-[#ffffff]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
